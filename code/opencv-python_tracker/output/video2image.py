...
input_file  = "./car1_kcf_opencv/car1_kcf_opencv.m4v"
output_file_prefix = "./car1_kcf_opencv/car1_kcf_opencv"
...
def getFrame(cap, sec, count):
    ...
    if ret:
        ...
        cv2.putText(frame, "Frame No. "+str(int(count)), (100, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255,0,0), 2)
